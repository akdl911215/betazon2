...
import com.example.beApi.stream.DummyGenerator;
...
public class DummyGenerator {
    ...
    * */
    ...
    private String myCalendar(int start, int end) {
        int year = RefUtil.random.apply(start, end);
        int month = RefUtil.random.apply(1, 12);
        int date30 = RefUtil.random.apply(1, 30);
        int date31 = RefUtil.random.apply(1, 31);
        int date29 = RefUtil.random.apply(1, 29);
        int date28 = RefUtil.random.apply(1, 28);
        int date = 0;
        switch (month) {
            case 4:
            case 6:
